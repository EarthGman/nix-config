  ...
  outputs = { self, nixpkgs, ... }@inputs:
    ...
    in
    {
      ...
      nixosConfigurations = {
        ...
        garth = mkHost { hostName = "garth"; cpu = "intel"; gpu = "intel-igpu"; users = "g"; desktop = "hyprland"; displayManager = "sddm"; };
        ...
        pioneer = mkHost { hostName = "pioneer"; cpu = "intel"; gpu = "intel-igpu"; users = "bean"; desktop = "hyprlad,i3"; displayManager = "sddm"; };
